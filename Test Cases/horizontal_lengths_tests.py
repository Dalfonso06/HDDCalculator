...
class TestHorizontalLengths(unittest.TestCase):
    ...
    def test_length_of_path(self):
        ...
        # Calculate
        expected = 1614.88
        result = horizontal_lengths.HorizontalLenghts.length_of_path(h_lengths)
    ...
    def test_borehold_diameter(self):
        ...
        expected1 = 42.0
        expected2 = 30.0
        result1 = horizontal_lengths.HorizontalLenghts.borehole_diameter(outside_diameter1)
        result2 = horizontal_lengths.HorizontalLenghts.borehole_diameter(outside_diameter2)
